...
# Repo: https://github.com/enric0r/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/enric0r/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/enric0r/ProxmoxVED
...
source <(wget -qO- https://github.com/enric0r/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/enric0r/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/enric0r/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
