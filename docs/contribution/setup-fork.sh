...
# upstream   https://github.com/enric0r/ProxmoxVED.git (fetch)
# upstream   https://github.com/enric0r/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/enric0r/ProxmoxVED"
echo ""
