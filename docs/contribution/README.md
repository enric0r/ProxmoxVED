...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/enric0r/ProxmoxVED → Fork (top right)
...
git remote add upstream https://github.com/enric0r/ProxmoxVED.git
...
- **GitHub**: https://github.com/enric0r/ProxmoxVED
- **Issues**: https://github.com/enric0r/ProxmoxVED/issues
- **Discussions**: https://github.com/enric0r/ProxmoxVED/discussions
